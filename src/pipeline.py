...
# ==========================================
try:
    onibus = pd.read_csv(DATA_DIR / "onibus.csv")
    motoristas = pd.read_csv(DATA_DIR / "motorista.csv")
    linhas = pd.read_csv(DATA_DIR / "linha.csv")
    viagens = pd.read_csv(DATA_DIR / "viagem.csv")
    manutencoes = pd.read_csv(DATA_DIR / "manutencao.csv")
...
# ==========================================
dados_viagens.to_csv(DATA_DIR / "dados_viagens_tratados.csv", index=False)
custo_manutencao.to_csv(DATA_DIR / "custo_manutencao.csv", index=False)
manutencoes_abertas.to_csv(DATA_DIR / "manutencoes_abertas.csv", index=False)
